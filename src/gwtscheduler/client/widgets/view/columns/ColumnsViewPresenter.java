...
//    });
    ...
    eventBus.addHandler(MoveObjectEvent.TYPE, new MoveObjectHandler(){
      ...
      public void onMoveObject(MoveObjectEvent event) {
        ...
        CalendarObjectMoveEvent objectMovetEvent = new CalendarObjectMoveEvent(type, title, event.getDroppedObject(), oldColumn, event.getOldTime(), newColumn, event.getNewTime());
